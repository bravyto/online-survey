...
<head class="hidden-print">
    ...
    <!-- END THEME STYLES -->
    <link rel="shortcut icon" href="{{ asset('assets/img/mandiri-icon.png') }}"/>

    <!-- CHART PLUGIN -->
    <script type="text/javascript" src="{{ URL::asset('assets/plugins/jquery-1.10.2.min.js') }}"></script>
    <script src="{{ asset('assets/plugins/jquery.flot.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/plugins/jquery.flot.pie.js') }}" type="text/javascript"></script>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar"> @include('admin/layout/sidebar') </div>
    ...
    <script src="{{ asset('assets/plugins/jquery-te-1.4.0.min.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('assets/scripts/FileSaver.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/scripts/jspdf.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/scripts/jspdf.plugin.addimage.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/scripts/jspdf.plugin.png_support.js') }}" type="text/javascript"></script>


    <script src="{{ asset('assets/scripts/html2canvas.js') }}" type="text/javascript"></script>
    <script src="{{ asset('dist/sweetalert.min.js') }}" type="text/javascript"></script>
