...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" method="post" action="{{ url('apps/goodbye') }}">
        ...
        <div class="modal-footer">
			...
			<div class="form-group">
				<span style="font-size: 16px; color: green;">
					Terima kasih atas partisipasi Responden dalam
					pengisian {{ $name }}
				</span>
			</div>
		...
		<div class="form-actions">
			<button type="button" onclick="location.href='{{ url('auth/logout') }}';" class="btn btn-info pull-right">
			OK </button>
        </div>
